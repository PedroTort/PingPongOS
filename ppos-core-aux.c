...
void intereput_service_routine(int signum) {
    systemTime++;
    ...
    {
        //ver como fazer para diferenciar tarefa de usuario
        task_yield();
    }
    // printf ("\nSystem Time %d\n", systemTime);
}

void intereput_service_routine_init() {
// registra a ação para o sinal de timer SIGALRM
  action.sa_handler = intereput_service_routine ;
...
void after_ppos_init () {
    intereput_service_routine_init();
    // put your customization here
#ifdef DEBUG
    printf("\ninit - AFTER");
#endif
